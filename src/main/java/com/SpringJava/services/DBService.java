...
import com.SpringJava.domain.ItemPedido;
...
import com.SpringJava.domain.enums.Perfil;
...
import com.SpringJava.repositories.ItemPedidoRepository;
...
public class DBService {
	...
	public void instantiableTestDatabase() throws ParseException {
		...
		Cliente cli2 = new Cliente(null, "Ana Luiza", "analu@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("93888321", "3425625"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Rua Matos", "100", "casa", "Centro", "3877012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Floriano", "2106", null, "Centro", "28777012", cli2, c2);
